---
title: "All final variables must be initialized, but '{0}' and '{1}' aren't.  All final variables must be initialized, but '{0}' isn't.  All final variables must be initialized, but '{0}', '{1}', and {2} others aren't."
verbose_name: "final_not_initialized_constructor"
category: "bug-risk"
weight: 70
severity: "major"
---
