...
@contextmanager
def patch_env_values(toolbox_path, artifacts_path):
    ...
    try:
        ...
        os.environ["ARTIFACTS_PATH"] = old_artifacts_path
        os.environ["TOOLBOX_PATH"] = old_toolbox_path


def freeze_dict(unfrozen):
...
def test_duplicate_artifacts(tmp_path):
